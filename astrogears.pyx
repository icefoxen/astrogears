...
def find_ratios_explicit_loops2(int min_teeth, int max_teeth):
    cdef double gear_ratio
    cdef double error
    cdef int wheel1, pinion1, wheel2, pinion2
    cdef double wheel1d, pinion1d, wheel2d, pinion2d
    for wheel1 in range(min_teeth, max_teeth+1):
        for wheel2 in range(min_teeth, max_teeth+1):
            for pinion1 in range(min_teeth, max_teeth+1):
                for pinion2 in range(min_teeth, max_teeth+1):
                    wheel1d = wheel1
                    wheel2d = wheel2
                    pinion1d = pinion1
                    pinion2d = pinion2
                    gear_ratio = (wheel1d/pinion1d) * (wheel2d/pinion2d)
